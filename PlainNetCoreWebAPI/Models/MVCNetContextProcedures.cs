...
{
    public partial class MVCNetContext
    {
        private IMVCNetContextProcedures _procedures;

        public virtual IMVCNetContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new MVCNetContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IMVCNetContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class MVCNetContextProcedures : IMVCNetContextProcedures
    {
        private readonly MVCNetContext _context;

        public MVCNetContextProcedures(MVCNetContext context)
        {
            _context = context;
        }
